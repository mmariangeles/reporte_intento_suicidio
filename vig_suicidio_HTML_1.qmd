...
titulo_dinamico8 <- glue("Notificaciones de IS según region notificadora. Periodo SE 13/2023 a SE {SE_MAX}/ {anio_maximo}. Provincia del Neuquén. N =  {cant_notif}")
...
pendientes: sacar la columna de establecimiento

acomodar el orden de las columnas de las tablas en general
